...
CAN_HAS_PARAMS = [
    ...
    ("skimage.segmentation:mark_boundaries", True, True, {}, None),
    ("skimage.segmentation:mark_boundaries", False, False, {}, None),
    ("skimage.util:invert", True, True, {}, ()),
    ("skimage.util:invert", False, False, {}, ()),
    ("skimage.util:compare_images", True, True, {}, None),
    ("skimage.util:compare_images", False, False, {}, None),
    ("skimage.util:montage", True, True, {}, ()),
    ("skimage.util:montage", False, False, {}, ()),
    ("skimage.util:crop", True, True, {}, (1,)),
    ("skimage.util:crop", False, False, {}, (1,)),
    ("skimage.util:random_noise", True, True, {}, ()),
    ("skimage.util:random_noise", False, False, {}, ()),
    ("skimage.util:view_as_blocks", True, True, {}, ((2, 2),)),
    ("skimage.util:view_as_blocks", False, False, {}, ((2, 2),)),
    ("skimage.util:view_as_windows", True, True, {}, ((2, 2),)),
    ("skimage.util:view_as_windows", False, False, {}, ((2, 2),)),
    ("skimage.color:rgb2gray", True, True, {}, ()),
    ("skimage.color:rgb2gray", False, False, {}, ()),
    ("skimage.color:gray2rgb", True, True, {}, ()),
    ("skimage.color:gray2rgb", False, False, {}, ()),
    ("skimage.color:label2rgb", True, True, {}, ()),
    ("skimage.color:label2rgb", False, False, {}, ()),
    ("skimage.color:rgb2hsv", True, True, {}, ()),
    ("skimage.color:rgb2hsv", False, False, {}, ()),
    ("skimage.color:hsv2rgb", True, True, {}, ()),
    ("skimage.color:hsv2rgb", False, False, {}, ()),
    ("skimage.color:rgb2lab", True, True, {}, ()),
    ("skimage.color:rgb2lab", False, False, {}, ()),
    ("skimage.color:lab2rgb", True, True, {}, ()),
    ("skimage.color:lab2rgb", False, False, {}, ()),
    ("skimage.restoration:denoise_tv_chambolle", True, True, {}, ()),
    ("skimage.restoration:denoise_tv_chambolle", False, False, {}, ()),
    ("skimage.restoration:richardson_lucy", True, True, {}, None),
    ("skimage.restoration:richardson_lucy", False, False, {}, None),
